            ...
            <li className="bg-white mb-3" style={{
                ...
                <div className="form-row p-3">
                    ...
                    <div className="col-md-3">
                        <div className="form-group">
                            <label htmlFor="exampleInputEmail1">No Telp</label>
                            <input value={item.phone} type="number" className="textonly form-control" name="phone" onChange={handleChangeInput} />
                        </div>
                    </div>
                    <div className="col-md-3">
                        <div className="form-group">
