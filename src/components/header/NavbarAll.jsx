...
function Navbar() {
    ...
    return (
        <div className={`sticky-top desktop-only p-0 bg-white`}>
                    ...
                    <ul className="navbar-nav d-flex  align-items-center">
                        <li className="nav-item">
                            <Dropdown toggle={handleOpenDownload} isOpen={downloadOpen}>
                                ...
                                >
                                    <div className={`d-flex mr-3 mt-1 text-dark`}>
                                        <Icon icon="heroicons:device-phone-mobile-20-solid" className={`mt-1 text-primary`} />
                                        <span className='ml-2' style={{ fontSize: '15px' }}>
                                            Unduh Aplikasi
                                        </span>
                                        <span className={`ml-2 mb-1 text-primary`}><Icon icon="ep:arrow-down" style={{ fontSize: '12px' }} /></span>
                                    </div>
                                </DropdownToggle>
                        ...
                        <li className="nav-item mr-3">
                            <Link href="/promo">
                                <a style={{ fontSize: '15px' }} className={`text-dark`}>
                                    Promo
                                </a>
                            </Link>
                        </li>
                        ...
                        {!auth ? <>
                            <li className="nav-item notlogged mr-2 ml-3">
                                <Link href='/login' passHref>
                                    <a className={`btn btn-sm font-weight-bold btn-outline-primary`}><Icon icon="gridicons:user" className={`mr-2 text-primary`} /> Log In</a>
                                </Link>
                            </li>
                                ...
                                <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                                    <DropdownToggle style={{ background: 'none', border: 'none' }}>
                                        <a className="nav-link d-flex justify-content-center align-items-center" href="#">
                                            ...
                                            <span
                                                className={`d-inline-block font-weight-bold text-primary`}
                                                style={{
                                            ...
                                            <span className={`mx-2 font-weight-bold text-primary`}> | </span>
                                            <span className={`font-weight-bold text-primary`}><Icon icon="tabler:coin-monero-filled" className="mr-1 mb-1 text-warning" /> 0</span>
                                            <span className={`ml-2 mb-1 text-primary`}><Icon icon="ep:arrow-down" style={{ fontSize: '12px' }} /></span>
                                        </a>
                                    </DropdownToggle>
                                    <DropdownMenu right>
            ...
            <nav className={`navbar navbar-expand-sm px-5`} style={{ marginTop: '-15px', boxShadow: '-1px 3px 11px -7px rgba(156,156,156,0.75)' }} >
                <div className="navbar-brand" style={{ cursor: 'pointer' }}>
                    <ul className="navbar-nav d-flex align-items-center">
                        <li className="nav-item mr-4 ml-3">
                            <Link href="/hotels">
                                <a style={{ fontSize: '15px' }} className={`font-weight-bold text-dark`}>
                                    Hotel
                                </a>
                            </Link>
                        </li>
