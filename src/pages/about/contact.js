                    ...
                    < div className="row">
                        ...
                        <div className="col-md-8">
                            <div className="my-5 py-5">
                                <h1 className="display-4 mb-3 font-weight-bold">Hubungi Kami</h1>
                                <p className="lead">Untuk hal yang mendesak, Anda bisa menelepon kami 24 jam ke nomor lokal atau internasional.</p>

                                <a href='https://wa.me/6282255003535' target={"_blank"} className="btn btn-warning my-3 text-left" style={{ borderRadius: 10, backgroundColor: '#FFF', width: 300 }}>
                                    <img src="https://www.freepnglogos.com/uploads/whatsapp-png-image-9.png" style={{ width: 50 }} />
                                    <span className="mt-10" style={{ fontSize: 28, fontWeight: 'bold' }}>0822-5500-3535</span>
                                </a><br />


                                <a href='/login' className="btn btn-warning my-3" target={'_blank'}>Login</a>
                                <a href='/register' className="btn btn-warning my-3 ml-4" target={'_blank'}>Daftar</a>
                            </div>
                        </div>
                    </div>
                </div >
