                    ...
                    <div className="card-body">
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label htmlFor="type">Tipe <span className='text-danger'>*</span></label>
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label>Sebutan / Panggilan <span className='text-danger'>*</span></label>
                            ...
                            <div className="col-md-4">
                                <div className="form-group">
                                    <label>Nomor handphone <span className='text-danger'>*</span></label>
                        ...
                        <div className="btn-submit d-flex justify-content-end">
                            <Link href="/user/quickpick">
                                <a className="btn btn-light text-primary mr-3">Batal</a>
                            </Link>
