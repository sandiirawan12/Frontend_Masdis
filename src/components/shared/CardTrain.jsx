                ...
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        {isLoading ?
                            ...
                            :
                            <>
                                <span className="badge bg-light p-1 text-primary" style={{ marginTop: '-5px', fontSize: '16px' }}><Icon icon="fluent-emoji:seat" className='mr-2' /> {train.ketersediaan_kursi} Kursi</span>
                            </>
                        }
                    </div>
                </div>
                            ...
                            <>
                                <div className="d-flex align-items-center text-center">
                                    ...
                                    <div className='mx-3'>
                                        ...
                                        <p>{train.code_station_awal} <Icon icon="solar:arrow-right-line-duotone" /> {train.code_station_akhir}</p>
                                    </div>
                                    <div>
