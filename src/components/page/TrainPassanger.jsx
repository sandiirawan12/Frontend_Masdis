...
function TrainPassanger() {
    ...
    const handleAddFromQuickpick = (name, target, { title, firstname, lastname, id_type, phone, identificationNumber, tglLahir }) => {
        ...
        newPassenger[indexOf] = { ...detailPassenger, title, firstName: firstname, lastName: lastname, id_type: id_type, phone: phone, identificationNumber: identificationNumber, dob: tglLahir }
