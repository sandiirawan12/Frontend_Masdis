                                ...
                                <div className="col-12">
                                    <div className='mb-2 mt-2' onClick={handleOpenMap}>
                                        <p className="mb-0 text-secondary">
                                            ...
                                            <span style={{ cursor: 'pointer', }} className="ml-1">{hotel.detail.address}, {hotel.detail.city}, {hotel.detail.country} - <span className='text-primary  font-weight-bold  '> Great location - Show Map </span> </span>
                                        </p>
                                    </div>
                                </div>
                            </div>
