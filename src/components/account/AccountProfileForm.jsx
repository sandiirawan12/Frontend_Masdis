    ...
    return (
        <RootStyled>
            <div className={"form-row"}>
                ...
                <div className="col-md-5 col-xs-12">
                    <div className="form-group">
                        <LabelStyled>Nama Belakang</LabelStyled>
                ...
                <div className="col-md-6 col-xs-12">
                    <div className="form-group">
                        <LabelStyled>No Handphone</LabelStyled>
                ...
                {isTabletOrMobile ?
                    <div style={{
                        ...
                        <ButtonStyled type="submit" onClick={handleSubmit} className="btn btn-primary btn-save">Simpan</ButtonStyled>
                    </div>
                    : <div className="col-md-12 d-flex justify-content-end">
                        <ButtonStyled onClick={handleSubmit} type="submit" className="btn btn-primary btn-save">Simpan</ButtonStyled>
                    </div>
